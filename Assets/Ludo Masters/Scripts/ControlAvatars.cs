...
public class ControlAvatars : MonoBehaviour
{
    ...
    public void PlayerJoined(int index, string id)
    {
        ...
        if (GameManager.Instance.opponentsIDs.Contains(id))
        {
            ...
            if (GameManager.Instance.opponentsAvatars[index] != null){
                Common.ScreenLog.ForceLog("Yes player avatar is available");
            ...
            {
                Common.ScreenLog.ForceLog("Enough players avatars");
            ...
            {
                Common.ScreenLog.ForceLog("Not enough players avatars");
    ...
    private void startGame()
    {
        ...
        if (!GameManager.Instance.offlineMode)
        {
            ...
            PhotonNetwork.RaiseEvent(199, GameManager.Instance.cueIndex + "-" + GameManager.Instance.cueTime, new Photon.Realtime.RaiseEventOptions(), new ExitGames.Client.Photon.SendOptions() { Reliability = true });
        }
