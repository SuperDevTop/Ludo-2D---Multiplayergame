...
public class GameDiceController : MonoBehaviour
{
    ...
    public void RollDice()
    {
        if (isMyDice)
        {
            Common.ScreenLog.ForceLog("Roll Dice");
            ...
            PhotonNetwork.RaiseEvent((int)EnumGame.DiceRoll, data, new Photon.Realtime.RaiseEventOptions(), new ExitGames.Client.Photon.SendOptions() { Reliability = true });
            Common.ScreenLog.ForceLog("Value:- "+ steps);
