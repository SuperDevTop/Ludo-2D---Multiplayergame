...
public class LudoGameController : MonoBehaviourPunCallbacks, IMiniGame
{
    ...
    void Start()
    {
        ...
        Debug.Log(" @@@@@@@@@@@@@@@@@@@@@@@@@@ Scaler width = "+ scalerWidth);
    ...
    {
        Debug.Log("Received event Ludo: " + eventData.Code);

        if (eventData.Code == (int)EnumGame.DiceRoll)
        {

            gUIController.PauseTimers();
            string[] data = ((string)eventData.CustomData).Split(';');
        ...
        else if (eventData.Code == (int)EnumGame.PawnMove)
        {
            string[] data = ((string)eventData.CustomData).Split(';');
        ...
        else if (eventData.Code == (int)EnumGame.PawnRemove)
        {
