...
public class CueController : MonoBehaviour
{
    ...
    void OnApplicationPause(bool pauseStatus)
    {
        if (pauseStatus)
        {
            PhotonNetwork.RaiseEvent(151, 1, new Photon.Realtime.RaiseEventOptions(), new ExitGames.Client.Photon.SendOptions() { Reliability = true });
            PhotonNetwork.SendAllOutgoingCommands();
            Debug.Log("Application pause");
        }
        else
        {
            PhotonNetwork.RaiseEvent(152, 1, new Photon.Realtime.RaiseEventOptions(), new ExitGames.Client.Photon.SendOptions() { Reliability = true });
            PhotonNetwork.SendAllOutgoingCommands();
    ...
    public void IWon()
    {
        ...
        youWonMessage.GetComponent<Animator>().Play("YouWinMessageAnimation");
        if (!GameManager.Instance.offlineMode)
            PhotonNetwork.RaiseEvent(19, null, new Photon.Realtime.RaiseEventOptions(), new ExitGames.Client.Photon.SendOptions());
    }
    ...
    public void Draw()
    {
        ...
        youWonMessage.GetComponent<Animator>().Play("YouWinMessageAnimation");
        if (!GameManager.Instance.offlineMode)
            PhotonNetwork.RaiseEvent(21, null, new Photon.Realtime.RaiseEventOptions(), new ExitGames.Client.Photon.SendOptions());
    }
    ...
    public void ILost()
    {
        ...
        youWonMessage.GetComponent<Animator>().Play("YouWinMessageAnimation");
        if (!GameManager.Instance.offlineMode)
            PhotonNetwork.RaiseEvent(20, null, new Photon.Realtime.RaiseEventOptions(), new ExitGames.Client.Photon.SendOptions());
    }
