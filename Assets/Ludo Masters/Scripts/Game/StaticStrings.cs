namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string AndroidPackageName = "com.geniegaming.ludorealcash";
        public static string ITunesAppID = "11111111111";



        // Notifications
        public static string notificationTitle = "Ludo Real Cash";
        ...
        public static string PlayFabTitleID = "3B985";
        public static string PhotonAppID = "9ced6b4f-f42b-40eb-bb68-6617338d0cb4";
        public static string PhotonChatID = "";
        ...
        public static float chatPrice = 0.49f;
        public static float emojiPrice = 0.49f;
        // Chat packs names
